    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-between">
                <h5 class= "modal-title" id="exampleModalLabel">Tambah Data Siswa</5>
                ...
                <form method="post" action="{{ route ('siswa.submit')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="year"class="form-control" name="induk" id="induk" required/>
                        </div>
                        <div class="form-group col-md-6">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route ('siswa.ubah')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="induk">Nomor Induk</label>
                            <input type="year"class="form-control" name="induk" id="edit-induk" required/>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="nisn">NISN</label>
